<template>
  ...
  <main class="relative">
    <div class="dark:bg-darkColor px-16 md:px-40 py-6">
      <h1 class="font-titleFont text-3xl pb-4">New Arrivals</h1>
    ...
    <div>
      <h1 class="font-titleFont dark:bg-darkColor px-16 md:px-40 py-6 text-3xl">
        Summer Spotlight
      </h1>
      <NarrowCard />
    </div>
